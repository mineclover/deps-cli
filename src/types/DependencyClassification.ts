...
export interface CodeDependency extends BaseDependency {
  ...
  exportedMembers?: Array<string> // 사용된 export 멤버들
...
export interface DependencyNode extends FileNode {
  dependencies: Array<ClassifiedDependency>
  dependents: Array<string> // 이 파일에 의존하는 파일들
  clusters: Array<string> // 속한 클러스터들
  ...
  analysis: {
    ...
    cyclicDependencies: Array<string> // 순환 의존성
    riskFactors: Array<string> // 위험 요소들
  }
}
...
export interface DependencyReport {
  ...
  testAnalysis: {
    ...
    testDependencyGraph: Map<string, Array<string>>
  }

  codeAnalysis: {
    internalModules: number
    externalLibraries: number
    circularDependencies: Array<Array<string>>
  ...
  documentationAnalysis: {
    ...
    orphanedDocs: Array<string>
    documentationGraph: Map<string, Array<string>>
  }
