  ...
  program
    ...
    .addCommand(
      program
        ...
        .action(
          wrapAction(async (path: string, options: any) => {
  ...
  program
    ...
    .addCommand(
      program
        ...
        .action(
          wrapAction(async (strategy: string, path: string, options: any) => {
  ...
  program
    ...
    .addCommand(
      program
        ...
        .argument('[path]', 'Path to analyze', '.')
        .action(
          wrapAction(async (path: string, _options: any) => {
  ...
  program
    ...
    .addCommand(
      program
        ...
        .action(
          wrapAction(async (query: string, options: any) => {
            ...
            const documents = files
              .filter((file) => file.includes(query) || file.toLowerCase().includes(query.toLowerCase()))
              .map((file) => ({
                id: file.replace('.md', ''),
    ...
    .addCommand(
      program
        ...
        .option('--docs-path <path>', 'Path to generated documents', './docs/dependencies')
        .action(
          wrapAction(async (id: string, options: any) => {
            // 간단한 문서 경로 생성
