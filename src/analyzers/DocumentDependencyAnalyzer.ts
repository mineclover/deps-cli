...
export interface DocumentAnalysisResult {
  ...
  externalLinks: DocumentDependency[]      // 외부 링크
  assetReferences: DocumentDependency[]    // 이미지/파일 참조
  documentMetadata: {
    title?: string
    description?: string
    tags: string[]
...
export class DocumentDependencyAnalyzer {
  ...
  private classifyDocumentReferences(
    ...
    const documentRefs: DocumentDependency[] = []
  ...
  private classifyExternalLinks(
    ...
    const externalLinks: DocumentDependency[] = []
  ...
  private classifyAssetReferences(
    ...
    const assetRefs: DocumentDependency[] = []
